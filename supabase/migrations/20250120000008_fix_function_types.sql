...
-- Date: 2025-01-20
-- Description: Fix column types to match database schema

-- Drop existing function
DROP FUNCTION IF EXISTS get_user_notifications(INTEGER, INTEGER);

-- Recreate function with correct types matching the database schema
...
-- Comentário
COMMENT ON FUNCTION get_user_notifications IS 'Função para obter notificações do usuário com tipos corretos';