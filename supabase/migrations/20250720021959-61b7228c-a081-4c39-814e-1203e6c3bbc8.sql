-- Migração completa: Remover is_active e migrar para sistema baseado em licenças

-- 1. Criar função para verificar se usuário tem licença ativa
...
-- 2. Atualizar função is_current_user_admin para usar licenças
...
-- 3. Atualizar função is_license_valid para ser o controle principal
...
-- 4. Criar função admin para ativar licença de usuário
...
-- 5. Criar função admin para desativar licença de usuário
...
-- 6. Atualizar função admin_get_all_users para não usar is_active
...
-- 7. Atualizar políticas RLS para usar licenças ao invés de is_active
...
-- 8. Atualizar política para budgets
...
-- 9. Remover triggers antigos relacionados a is_active
...
-- 10. Remover coluna is_active da tabela user_profiles
